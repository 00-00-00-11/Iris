import { Client, ClientOptions, RequestTypes } from '../../Iris-Client-Rest';
import { AuthTypes } from '../../Iris-Client-Rest/Library/constants';
...
export declare class RestClient {
    ...
    editWebhookTokenMessage(webhookId: string, token: string, messageId: string, options?: RequestTypes.EditWebhookTokenMessage, updateCache?: boolean): Promise<Message>;
